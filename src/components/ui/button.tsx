...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      primary: "bg-rabiku-blue text-white hover:bg-rabiku-blue-dark shadow-md hover:shadow-lg hover:-translate-y-0.5",
      secondary: "bg-white text-rabiku-blue hover:bg-gray-50 shadow-md border border-gray-200 hover:border-rabiku-blue/30",
      outline: "border-2 border-rabiku-blue text-rabiku-blue hover:bg-rabiku-blue/10 hover:shadow-md",
    ...
    const sizes = {
      ...
      hero: "px-14 py-5 text-2xl rounded-2xl font-bold min-h-[72px] tracking-wide",
    };
